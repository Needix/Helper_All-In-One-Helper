...
namespace AllInOneHelper.Modules.MouseRecord {
    class MouseKey_Recorder : BaseController {
        ...
        private volatile Boolean _abortPositionThread; public Boolean AbortPositionThread { set { _abortPositionThread = value; } }
        ...
        public void PauseRec(object sender, EventArgs e) {
            ...
            if(!SetRecordPanel.b_mouseRec_rec_stop.Enabled) return; // Check if stop is enabled to ensure that stopRec didnt trigger this function
